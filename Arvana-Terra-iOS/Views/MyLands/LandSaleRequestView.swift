...
struct LandSaleRequestView: View {
    let landId: String
    let landName: String
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    HStack(spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            ...
                            Text("土地").font(.caption).foregroundColor(Color.textGray)
                        }
                    }
                    ...
                    if viewModel.isSuccess {
                        ...
                        Group {
                            ...
                            // Description
                            VStack(alignment: .leading, spacing: 8) {
                                Text("土地の説明・特徴").font(.subheadline).fontWeight(.medium)
                        ...
                        Button {
                            Task { await viewModel.submit(type: "land", landId: landId) }
                        } label: {
