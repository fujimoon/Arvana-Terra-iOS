                    ...
                    if viewModel.isSuccess {
                        ...
                        Group {
                            VStack(alignment: .leading, spacing: 8) {
                                Text("土地名 *").font(.subheadline).fontWeight(.medium)
                                TextField("土地名を入力", text: $viewModel.name)
                        ...
                        Button {
                            Task { await viewModel.createLand() }
                        } label: {
